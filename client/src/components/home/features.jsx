...
const features = () => {
  ...
  return (
    <div id='features' className=" py-16 px-4 md:px-8 lg:px-16">
       ...
       <div className="inline-flex items-center gap-2 text-sm text-green-600 bg-green-400/10 rounded-full px-4 py-1">
        ...
        <Title
            title="Features for Career Success"
            description="Build, customize, and optimize your resume with AI-driven tools designed to help you land more interviews."
            />
